...
export interface HeaderProps {
  ...
  /**
   * Optional outer subtitle container style override.
   */
...
export function Header(props: HeaderProps) {
  ...
  const subtitleContent = subtitleTx
    ? translate(subtitleTx, subtitleTxOptions)
    : subtitle;
          ...
          <View
            ...
            {subtitleContent && (
              <Text
                ...
                style={[themed($subtitle), $subtitleStyleOverride]}
              />
            )}
          </View>
        )}
